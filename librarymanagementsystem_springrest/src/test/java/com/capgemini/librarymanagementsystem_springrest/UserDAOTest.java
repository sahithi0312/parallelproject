package com.capgemini.librarymanagementsystem_springrest;
...
import com.capgemini.librarymanagementsystem_springrest.dao.UsersDAO;
...
public class UserDAOTest {
	...
	public void testRegisterValid() {
		...
		bean.setFirstName("Sri");
		bean.setLastName("maddi");
		bean.setEmail("sri@gmail.com");
		bean.setPassword("Sri@123");
	...
	public void testLoginValid() {
		UsersBean info = dao.login("sri@gmail.com", "Sri@123");
	...
	public void testUpdatePasswordValid() {
		boolean check = dao.updatePassword(100102, "Sai@123", "Sai@1234", "admin");
		Assertions.assertTrue(check);
	}
