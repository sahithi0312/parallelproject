...
public class AdminServiceTest {
	...
	public void testRegisterAdminValid() {
		...
		adn.setId(123445);
		adn.setName("sahithi");
		adn.setMobile(8790456211l);
		adn.setEmail("maddisahithi@gmail.com");
		adn.setPassword("Sahithi@123");
	...
	public void testLoginAdminValid() {
		Admin info = service.loginAdmin("sahithi@gmail.com", "Sahithi@123");
		Assertions.assertNotNull(info);
	}

	@Test
	public void testLoginAdminInvalid() {
		Admin info = service.loginAdmin("maddisahithi@gmail.com", "sahithi@123");
