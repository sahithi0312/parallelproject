...
public class UserDAOTest {
	...
	public void testLoginValid() {
		UsersBean info = dao.login("satya@gmail.com", "Satya@123");
		Assertions.assertNotNull(info);
	}
	
	@Test
	public void testLoginInvalid() {
		UsersBean info = dao.login("aaaaa@gmail.com", "ammU123");
	...
	public void testUpdatePasswordValid() {
		boolean check = dao.updatePassword("satya@gmail.com", "Satya@123", "Admin@123", "admin");
		Assertions.assertTrue(check);
	}
